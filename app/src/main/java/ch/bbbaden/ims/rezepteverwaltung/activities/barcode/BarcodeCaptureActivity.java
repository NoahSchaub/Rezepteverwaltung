 ...
 */
package ch.bbbaden.ims.rezepteverwaltung.activities.barcode;
...
import ch.bbbaden.ims.rezepteverwaltung.activities.camera.*;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                new Toaster(this, getString(R.string.low_storage_error),1);
